...
import { deleteCustomer, fetchCustomer } from './store/customer.action'
...
const CustomerList = () => {
    ...
    const { entities } = useSelector((state) => state.customer)
