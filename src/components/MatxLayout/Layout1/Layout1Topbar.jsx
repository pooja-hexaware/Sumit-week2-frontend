...
import { setTotalPrice } from '../../../views/store/store/storeSlice';
...
const Layout1Topbar = () => {
	...
	var { cartData, menuPrice, toppingPrice } = useSelector((state) => state.store);
